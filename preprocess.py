...
if not os.path.exists(outdir):
    os.mkdir(outdir)
discharge_train_snippets.to_csv('./discharge2/train.csv')
discharge_val.to_csv('./discharge2/val.csv')
discharge_test.to_csv('./discharge2/test.csv')
...
if not os.path.exists(outdir):
    os.mkdir(outdir)
early_train_snippets.to_csv('./3days2/train.csv')

early_val = df_less_3[df_less_3.ID.isin(val_id_label.id)]
early_val.to_csv('./3days2/val.csv')
...
early_test.to_csv('./3days2/test.csv')
...
if not os.path.exists(outdir):
    os.mkdir(outdir)
early_test_2days.to_csv('./2days2/test.csv')